...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
   ...
   COMMENT ON COLUMN "SYS_UPI"."LOG_TB"."LOG_DATE" IS '로그날짜';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
   ...
   COMMENT ON COLUMN "SYS_UPI"."REPORT_TB"."LOG_NUM" IS '로그 번호';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYS_UPI"."LOG_TB" MODIFY ("LOG_DATE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYS_UPI"."REPORT_TB" MODIFY ("LOG_NUM" NOT NULL ENABLE);
