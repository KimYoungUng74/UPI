...
A등급 조치';
   ...
   COMMENT ON COLUMN "SYS_UPI"."GRADE_TB"."RECODE_DATE" IS '기록날짜';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYS_UPI"."GRADE_TB" MODIFY ("RECODE_DATE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYS_UPI"."INDICATORS_TB" MODIFY ("RECODE_DATE" NOT NULL ENABLE);
