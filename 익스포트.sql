...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYS_UPI"."CONTROL_NUM"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence GRADE_NUM
--------------------------------------------------------

   CREATE SEQUENCE  "SYS_UPI"."GRADE_NUM"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYS_UPI"."INDICATORS_NUM"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence RECORD_NUM
--------------------------------------------------------

   CREATE SEQUENCE  "SYS_UPI"."RECORD_NUM"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
   ...
   COMMENT ON COLUMN "SYS_UPI"."INDICATORS_TB"."IS_NEGATIVE" IS '정적 - 0, 부적 -1';
