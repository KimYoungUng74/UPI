...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<c:url value='/resources/template/assets/extra-libs/c3/c3.min.css'/>" rel="stylesheet">
    <link href="<c:url value='/resources/template/assets/libs/chartist/dist/chartist.min.css'/>" rel="stylesheet">
    <link href="<c:url value='/resources/template/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css'/>" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="<c:url value='/resources/template/dist/css/style.min.css'/>" rel="stylesheet">
...
<body>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="<c:url value='/resources/template/assets/libs/jquery/dist/jquery.min.js'/>"></script>
    <script src="<c:url value='/resources/template/assets/libs/popper.js/dist/umd/popper.min.js'/>"></script>
    <script src="<c:url value='/resources/template/assets/libs/bootstrap/dist/js/bootstrap.min.js'/>"></script>
    <!-- apps -->
    <!-- apps -->
    <script src="<c:url value='/resources/template/dist/js/app-style-switcher.js'/>"></script>
    <script src="<c:url value='/resources/template/dist/js/feather.min.js'/>"></script>
    <script src="<c:url value='/resources/template/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js'/>"></script>
    <script src="<c:url value='/resources/template/dist/js/sidebarmenu.js'/>"></script>
    <!--Custom JavaScript -->
    <script src="<c:url value='/resources/template/dist/js/custom.min.js'/>"></script>
    <!--This page JavaScript -->
    <script src="<c:url value='/resources/template/assets/extra-libs/c3/d3.min.js'/>"></script>
    <script src="<c:url value='/resources/template/assets/extra-libs/c3/c3.min.js'/>"></script>
    <script src="<c:url value='/resources/template/assets/libs/chartist/dist/chartist.min.js'/>"></script>
    <script src="<c:url value='/resources/template/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js'/>"></script>
    <script src="<c:url value='/resources/template/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js'/>"></script>
    <script src="<c:url value='/resources/template/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js'/>"></script>
    <script src="<c:url value='/resources/template/dist/js/pages/dashboards/dashboard1.min.js'/>"></script>
</body>
