			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-7 align-self-center">
						<h3
							class="page-title text-truncate text-dark font-weight-medium mb-1">지표
							총괄 결과표</h3>
						<div class="d-flex align-items-center">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb m-0 p-0">
									<li class="breadcrumb-item"><a href="index.html">이번년도
											총괄 결과를 표로 확인하실 수 있습니다.</a></li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<button
									class="btn btn-primary waves-effect waves-light btn-hwp-1"
									margin-left: 10px;
									type="button">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body row">
								<div class="col-md-6">
									<span>년도 선택 </span> <select class="form-control" id="Years"
										onChange="location.href='result_grid_view.do?Years='+value">
										<option value="2022"
											<c:if test="${Years=='2022'}" >selected="selected"</c:if>>2022</option>
										<option value="2021"
											<c:if test="${Years=='2021'}" >selected="selected"</c:if>>2021</option>
										<option value="2020"
											<c:if test="${Years=='2020'}" >selected="selected"</c:if>>2020</option>
										<option value="2019"
											<c:if test="${Years=='2019'}" >selected="selected"</c:if>>2019</option>
										<option value="2018"
											<c:if test="${Years=='2018'}" >selected="selected"</c:if>>2018</option>
										<option value="2017"
											<c:if test="${Years=='2017'}" >selected="selected"</c:if>>2017</option>
									</select>
								</div>

								<div class="col-md-2">
									<span>분기 선택</span> <select class="form-control" id="Divive"
										onChange="location.href='result_grid_view.do?Divive='+value">
										<option value="0"
											<c:if test="${Divive==0}" >selected="selected"</c:if>>전체</option>
										<option value="1"
											<c:if test="${Divive==1}" >selected="selected"</c:if>>1분기</option>
										<option value="2"
											<c:if test="${Divive==2}" >selected="selected"</c:if>>2분기</option>
										<option value="3"
											<c:if test="${Divive==3}" >selected="selected"</c:if>>3분기</option>
										<option value="4"
											<c:if test="${Divive==4}" >selected="selected"</c:if>>4분기</option>
									</select>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<table class="table table-bordered table-striped mb-0"
										...
										<thead>
											<tr>
												<th class="text-center" rowspan="2">연번<br>
												<br>
												<br></th>
												<th class="text-center" rowspan="2">지 표 명<br>
												<br>
												<br>
												</th>
												<th class="text-center" colspan="2">평 가 지 표<br>
												</th>
											...
											<tr>
												...
												<th class="text-center">목표값<br>

												</th>
												<th class="text-center">현재값<br>

												</th>

												<th class="text-center">등급<br>

												</th>
												<th class="text-center">달성도<br>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<button
									class="btn btn-primary waves-effect waves-light btn-hwp-2"
									margin-left: 10px;
									type="button">
									<span class="btn-label"><i class="far fa-file-alt"></i></span>HWP로
									저장
...
<script>
	...
	$('.btn-hwp-2').click(
			function() {
				...
				var footer = "</body></html>";
				var sourceHTML = header
						+ document.getElementById("grade-view").innerHTML
						+ footer;
				var source = 'data:application/vnd.ms-word;charset=utf-8,'
						+ encodeURIComponent(sourceHTML);
				var fileDownload = document.createElement("a");
